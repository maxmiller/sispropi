class CollegesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @college.save
        format.html { render action: 'new', notice: 'College was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @college.update(college_params)
        format.html { render action: 'new', notice: 'College was successfully updated.' }
  ...
  private
    ...
    def college_params
      params.require(:college).permit(:name, :acronym)
    end
end
